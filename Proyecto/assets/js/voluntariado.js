...
-¿Qué métodos o funciones hay para borrar?
-¿para eliminar un elemento de un array de objetos mediante un botón en una card hay que igualar el valor del botón con el índice del array?
-¿usuarios.splice(index, 1); // Elimina el usuario del array vale el index es el indice del array y el 1 que es?
-¿Si elimino un voluntariado que tengo en un array definido en el archivo datos al recargar la pagina volvera a aparecer verdad?
